...
import "./OrganixState.sol";

// Internal References
import "./interfaces/IFeePool.sol";

contract OrganixStateWithLimitedSetup is OrganixState, LimitedSetup {
    ...
    constructor(address _owner, address _associatedContract)
        public
        OrganixState(_owner, _associatedContract)
    ...
    //  */
    function importIssuerData(address[] calldata accounts, uint[] calldata oUSDAmounts) external onlyOwner onlyDuringSetup {
