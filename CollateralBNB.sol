...
import "./interfaces/ICollateralBNB.sol";

// This contract handles the payable aspects of BNB loans.
contract CollateralBNB is Collateral, ICollateralBNB, ReentrancyGuard {
