...
contract EmptyCollateralManager is ICollateralManager {
    ...
    function totalLong() external view returns (uint ousdValue, bool anyRateIsInvalid) {
        return (0, false);
    }

    function totalShort() external view returns (uint ousdValue, bool anyRateIsInvalid) {
        return (0, false);
    }
