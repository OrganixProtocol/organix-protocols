...
// FlagsInterface from Chainlink addresses OIP-76
...
contract ExchangeRates is Owned, MixinSystemSettings, IExchangeRates {
    ...
    // Exchange rates and update times stored by currency code, e.g. 'OGX', or 'oUSD'
    ...
    // OIP-75 Public keeper function to freeze a synth that is out of bounds
    ...
    // OIP-75 View to determine if freezeRate can be called safely
